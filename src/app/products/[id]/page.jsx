...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: product.image || "https://i.ibb.co.com/Kzb2tzRv/Screenshot-2025-12-22-232710.png",
          width: 1200,
          height: 630,
          alt: product.title,
        },
    ...
    twitter: {
      ...
      images: [product.image || "https://i.ibb.co.com/Kzb2tzRv/Screenshot-2025-12-22-232710.png"],
    },
  };
}
